...
# Automatically set multiprocessing start method to "fork" if running on macOS.
import platform
...
# Set default dtype for PyTorch based on the backend being used. (MPS uses float32, others use float64)
...
if __name__ == "__main__":
    ...
    else:  # added for macOS users
        print('Running on CPU 🧠 or macOS GPU 🖥️')
        torch.set_float32_matmul_precision('medium')
